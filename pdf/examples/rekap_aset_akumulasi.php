...
$html.='<table style=" border-collapse: collapse;" border="1">
        <thead>
        <tr>
            <th align="center"><b>KELOMPOK</b></th>
            <th align="center"><b>NILAI PEROLEHAN</b></th>
            <th align="center"><b>PENYUSUTAN</b></th>
            <th align="center"><b>NILAI BERSIH</b></th>
        </tr>
        </thead>
...
while ($r=mysqli_fetch_array($perintah)) { 
    $html.='        
        <tr><td colspan="4"><b>'.$r['kategori'].'</b></td></tr>
    ';
    ...
    while ($r2=mysqli_fetch_array($perintah2)) {
        ...
        $html.='
        <td align="right">Rp. '.number_format($total_subkategori).'</td>
        <td align="right">Rp. '.number_format($total_subkategori).'</td>
        <td align="right">Rp. '.number_format($total_subkategori).'</td>        
        </tr>
        ';
