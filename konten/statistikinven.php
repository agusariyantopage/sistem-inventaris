                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                        ...
                        $sql="select kategori.id_kategori,kategori,COUNT(IF(kondisi = 'Baik', 1, NULL)) as qty_baik,COUNT(IF(kondisi = 'Rusak', 1, NULL)) as qty_rusak from kategori left join subkategori on kategori.id_kategori=subkategori.id_kategori LEFT JOIN barang on barang.id_subkategori=subkategori.id_subkategori left join barang_detail on barang_detail.id_barang=barang.id_barang GROUP by kategori";
