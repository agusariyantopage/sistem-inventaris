...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
		  <div class="col-sm-6">
		    <h1 class="m-0">Perbaiki Lokasi , Jumlah dan Catatan Item</h1>
		  </div><!-- /.col -->
		  <div class="col-sm-6">
		    <ol class="breadcrumb float-sm-right">
		      <li class="breadcrumb-item"><a href="#">Inventaris</a></li>
              <li class="breadcrumb-item"><a href="#">Input Inventaris</a></li>
              <li class="breadcrumb-item"><a href="index.php?p=inventarisperbaikan">Perbaikan Data</a></li>              
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Formulir Perubahan Data</b></h3>
              </div>  	
            		<div class="card-body">
						<!-- Isian Form -->
						<form method="post" action="aksi_inventarisperbaikan_ubah.php">
							...
							<div class="form-group">
								...
								<div class="row">
									...
									<input required="" type="number" name="qtybaik" id="qtybaik" placeholder="Kondisi Baik" value="<?= $qtybaik; ?>" class="form-control">
									</div>
									<div class="col-6">
									<label for="merk">Jumlah Barang Rusak</label>
									<input type="number" value="<?= $qtyrusak; ?>" name="qtyrusak" id="qtyrusak" placeholder="Kondisi Rusak" class="form-control">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="lokasi">Lokasi Barang</label>
								<input  type="text" required="" name="lokasi" id="lokasi" placeholder="Masukkan Lokasi . . ." value="<?= $lokasi; ?>" class="form-control">
							</div>
							<div class="form-group">
