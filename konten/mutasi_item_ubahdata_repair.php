		...
		<div class="row mb-2">
		  ...
		  <div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item active">Laporan Pemulihan</li>
			</ol>
		  </div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Laporan Pemulihan</h3>
              </div>  	
            		<div class="card-body">
						<!-- Isian Form -->
						<form method="post" action="aksi_mutasi_item_ubahdata_repair.php">
							<input name="id" id="id" type="hidden" value="<?= $r1['id_barang_detail']; ?>">
							<input name="id_barang" id="id_barang" type="hidden" value="<?= $r1['id_barang']; ?>">
							...
							<div class="form-group">
								...
								<input  type="text" readonly="" value="<?= $r1['lokasi']; ?>" name="lokasi" id="lokasi" placeholder="Masukkan Lokasi . . ." class="form-control">
							</div>
							<div class="form-group">
								<label for="status">Status</label>
								<input  type="text" value="Baik" name="status" id="status" readonly="" class="form-control">
							</div>
							<div class="form-group">
								<label for="tglpulih">Tanggal Selesai Perbaikan</label>
								<input  type="date" required="" name="tglpulih" class="form-control">
							</div>
							<div class="form-group">
								<label for="catatan">Catatan</label>
								<textarea name="catatan" required="" class="form-control" placeholder="Masukkan Keterangan Perbaikan . . ." rows="3"></textarea>
							</div>						
							<button type="submit" id='submitFormx' class="btn btn-primary">Simpan</button>
