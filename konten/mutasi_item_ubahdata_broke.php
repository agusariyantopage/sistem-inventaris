            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Laporan Kerusakan</h3>
            		...
            		<div class="card-body">
						<!-- Isian Form -->
						<form method="post" action="aksi_mutasi_item_ubahdata_broke.php">
							...
							<div class="form-group">
								...
								<input  type="text" value="Rusak" name="status" id="status" readonly="" class="form-control">
							</div>
							<div class="form-group">
								<label for="tglrusak">Tanggal Mulai Rusak</label>
								<input  type="date" required="" name="tglrusak" class="form-control">
							</div>
							<div class="form-group">
								<label for="catatan">Catatan</label>
								<textarea name="catatan" required="" class="form-control" placeholder="Masukkan Keterangan Kerusakan . . ." rows="3"></textarea>
							</div>						
