                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      ...
                      if($_SESSION['level']==1) {
                        $sql="select tambah.*,nama_panjang from tambah,unit_kerja where tipe_sumber='Bantuan' and tambah.id_unit=unit_kerja.id_unit";
                      } else {
                        $id_unit= $_SESSION['idunit'];
                        $sql="select tambah.*,nama_panjang from tambah,unit_kerja where tipe_sumber='Bantuan' and tambah.id_unit=unit_kerja.id_unit and tambah.id_unit=$id_unit";
                        //echo $sql;
                      }
                      // -- Akses Yayasan / Unit Kerja 
