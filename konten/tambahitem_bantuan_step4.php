          ...
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>              
                      <tr>
                        ...
                        <td><?= $r['lokasi']; ?></td> 
                        <td align="center">
                            <a onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Ini?')" href="aksi_tambahitem_bantuan_delete_item.php?id=<?= $r['id_tambah_detail']; ?>"><span class="fas fa-trash"></span></a>
                            &nbsp;                                                       
                        </td>
                      </tr>
                  <?php
                ...
                <a href="index.php?p=tambahitem-bantuan-step2">
                  <button class="btn btn-primary">Tambah Item Lain</button>
                </a>
                <a href="aksi_tambahitem_bantuan_step4.php?id=<?= $id_tambah; ?>">
