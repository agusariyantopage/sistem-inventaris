          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><b>Pilih Barang </b>| Tentukan Jumlah Barang</h3>
              </div> 
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>              
                      <tr>
                        ...
                        <td><?= $r['spesifikasi']; ?></td>              
                        <td align="center">
                            <a href="index.php?p=addinventaris&id=<?= $r['id_barang']; ?>"><span class="fas fa-check-circle"></span></a>
                            &nbsp;                                                       
                        </td>
                      </tr>
                  <?php
                ...
                <a href="index.php?p=addbarang&rd=inventaris">
