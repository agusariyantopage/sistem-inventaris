          ...
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <i>Note Bila Katalog Barang Belum Terdaftar Tekan Tombol <b>Tambah Katalog Barang</b> Di Bagian Bawah</i>
                    ...
                    ?>              
                      <tr>
                        ...
                        <td><?= $r['spesifikasi']; ?></td>              
                        <td align="center">
                            <a href="index.php?p=tambahitem-bantuan-step3&id=<?= $r['id_barang']; ?>"><span class="fas fa-check-circle"></span></a>
                            &nbsp;                                                       
                        </td>
                      </tr>
                  <?php
                ...
                <a href="index.php?p=addbarang&rd=tambahitem-bantuan-step2">
