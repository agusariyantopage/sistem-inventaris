              ...
              <div class="card-body">                
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                        $id=$_GET['id'];
                        $sql="select subkategori.id_subkategori,subkategori,COUNT(IF(kondisi = 'Baik', 1, NULL)) as qty_baik,COUNT(IF(kondisi = 'Rusak', 1, NULL)) as qty_rusak from subkategori LEFT JOIN barang on barang.id_subkategori=subkategori.id_subkategori left join barang_detail on barang_detail.id_barang=barang.id_barang where id_kategori=$id GROUP by subkategori";
                    ...
                    ?>              
                      <tr>
                        ...
                        <td><a href="index.php?p=statistikinven3&id=<?= $r['id_subkategori']; ?>"><?= $r['subkategori']; ?></a></td>
